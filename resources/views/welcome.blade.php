...
<head>
    ...
    <title>Portfolio - {{ $data['nama'] }}</title>
    ...
    <style>
        ...
        :root {
            ...
            --text-dark: #e3f2fd;
            --text-muted: #90caf9;
            --gradient-1: linear-gradient(135deg, #0d1b4a 0%, #1565c0 100%);
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .contact-info h3 { font-size: 2rem; color: var(--accent); margin-bottom: 1rem; }
        ...
        .contact-card h4 { color: var(--text-light); margin-bottom: 0.3rem; }
        ...
        .form-group i { position: absolute; left: 1rem; top: 1rem; color: var(--accent); }
                ...
                <div class="hero-image animate-fade-in-right">
                    <div class="image-wrapper">
                        ...
                        <div class="profile-image">
                            <img src="https://via.placeholder.com/400x400/1a237e/ffffff?text=Foto+Anda" alt="Profile">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="about-content">
                <div class="about-image reveal-left">
                    <div class="about-img-wrapper">
                        <img src="https://via.placeholder.com/500x600/1a237e/ffffff?text=About+Me" alt="About">
    ...
    <footer class="footer">
        <div class="footer-container">
            ...
            <div class="footer-bottom">
                <p>&copy; {{ date('Y') }} {{ $data['nama'] }}. All Rights Reserved. Made with ❤️</p>
            </div>
        </div>
    </footer>
